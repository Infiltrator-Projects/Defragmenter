...
def main() -> None:
    ...
    common_contract = (
        ...
        (
            'COMMON_COMMIT="748e089ae175329471d4cf375522c44081371bd5"',
    ...
    assert "Infiltratr Common 1.19.24" in design
    assert "748e089ae175329471d4cf375522c44081371bd5" in design
